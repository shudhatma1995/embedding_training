...
BASE_SLOTS = {
    ...
    "service_phrase": ["on spotify", "on apple music", "on youtube music", "on soundcloud", ""],
    "contact": [
        "john",
        "sarah",
        "mom",
    ...
    "food": ["pizza", "sushi", "a burger", "tacos", "coffee", "thai food", "a sandwich", "ramen"],
    "transport": ["flight", "taxi", "uber", "train ticket", "cab", "rideshare"],
    "n": ["5", "10", "15", "20", "30"],
    "n2": ["40", "60", "80", "100", "200"],
    "gibberish": ["asdfgh", "blah blah blah", "qwerty asdf", "lorem ipsum", "mmm hmm", "uhh what"],
    # timers_alarms
    "duration": [
        "10 minutes",
        "5 minutes",
    ...
    "timer_label": ["the pasta", "the laundry", "the oven", "my workout", "the tea", "the eggs"],
    ...
    "city": ["new york", "london", "paris", "tokyo", "chicago", "seattle", "miami", "denver"],
    # communication
    "message_topic": [
        "about the report",
        "that i'll be late",
